...
const outfit = Outfit({
  variable: "--font-geist-mono", // Using Outfit for headings/mono replacements
  subsets: ["latin"],
});
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${inter.variable} ${outfit.variable} antialiased selection:bg-primary/20 selection:text-primary flex flex-col min-h-screen relative`}
      >
        <Navbar />
